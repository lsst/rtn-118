...
The default appointment length is two years, but can be extended.

The total expected time commitment is ~5% FTE per year (2h/week).
...
The guidelines in this document are designed to fulfill these statements from the Charter.
